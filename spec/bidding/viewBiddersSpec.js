const viewBidders = require("../../src/API/bidding/viewBidders");
...
describe("view all the bidders ", () => {
  ...
  it("should return the all bidder on auction ", async () => {
    const s = await viewBidders.getBidders(
      {
        body: {
          auctionId: 1
        }
